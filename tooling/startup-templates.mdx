...
└── MyCompanyName.MyProjectName.abpsln  # ABP solution descriptor
```
...
The `templates/Directory.Packages.props` opts **out** of Centralized Package Management so template `.csproj` files manage their own versions:

```xml title="templates/Directory.Packages.props"
<Project>
  <PropertyGroup>
    <!-- Templates manage their own package versions per .csproj -->
    <ManagePackageVersionsCentrally>false</ManagePackageVersionsCentrally>
  </PropertyGroup>
</Project>
```

Each template's `common.props` carries a placeholder `Version` that the CLI substitutes at project creation time:
...
<Project>
  <PropertyGroup>
    ...
    <!-- Version is replaced by the CLI with the target ABP version -->
