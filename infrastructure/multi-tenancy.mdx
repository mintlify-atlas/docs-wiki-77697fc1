...
public override async Task<string> ResolveAsync(string? connectionStringName = null)
{
    ...
    if (connectionStringName == ConnectionStrings.DefaultConnectionStringName)
    {
    ...
    var specific = tenant.ConnectionStrings?.GetOrDefault(connectionStringName);
    return !specific.IsNullOrWhiteSpace() ? specific! : await base.ResolveAsync(connectionStringName);
}
```
