...
| `PIPE_TO_LOGIN` | `true` | Redirects to login on 401 |
| `TENANT_KEY` | `'__tenant'` | Cookie / query param name for current tenant |
| `COOKIE_LANGUAGE_KEY` | `'Abp.Localization.CultureName'` | Cookie holding the selected language |
