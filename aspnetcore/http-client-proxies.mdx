...
- **Custom converters** — `AbpHttpClientProxyingOptions.ObjectToQueryStringContributors` let you register `IObjectToQueryString<T>` implementations for complex types.

```csharp
// fragment: ClientProxyUrlBuilder.cs
